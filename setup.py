...
about = {}
with open("sfsidb/__about__.py") as fp:
    exec(fp.read(), about)

setup(name='sfsidb',
      version=about['__version__'],
      description='This package provides tools to view engineering databases',
      url='',
      author='Maxim Millen',
      ...
      classifiers=[
          ...
          'Intended Audience :: Structural engineering community',
